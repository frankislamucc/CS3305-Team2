...
// // === Pinch settings (thumb + index) ===
// const THUMB_TIP_INDEX = 4
// const INDEX_FINGER_TIP_INDEX = 8
// const PINCH_THRESHOLD_PX = 55 // adjust to taste

// // Variables for fist detection
// let clearedThisFist = false
// let lastClearTime = 0
// const clearDelay = 1000 // 1 second
...
// function isPinching(landmarks, width, height) {
...
// const indexfilterXY = new OneEuroFilter(t0, [0,0], 0.0, 1.2, 0.05, 1.0)
// const thumbFilterXY = new OneEuroFilter(t0, [0,0], 0.0, 1.2, 0.05, 1.0)
// const pinchIndexFilterXY = new OneEuroFilter(t0, [0,0], 0.0, 1.2, 0.05, 1.0)
...
//   if (results.multiHandLandmarks && results.multiHandLandmarks.length > 0) {
//     // Mirror horizontally for drawing coords
...
//     // 1) Fist clears the drawing canvas
//     if (isFist(landmarks)) {
//       if (!clearedThisFist) {
//         ctx.clearRect(0, 0, canvas.width, canvas.height)
//         prevX = null
...
//     // const timeSinceClear = Date.now() - lastClearTime
//     // if (timeSinceClear < clearDelay) return
//     if (Date.now() - lastClearTime < clearDelay) return


//     // 3) Pinch-to-draw gate
//     // const connected = isPinching(landmarks, canvas.width, canvas.height)
//     // const indexTip = landmarks[INDEX_FINGER_TIP_INDEX]
//     // const currentX = indexTip.x * canvas.width
//     // const currentY = indexTip.y * canvas.height
...
//     // 4) Draw hand landmarks on video overlay (not mirrored)
