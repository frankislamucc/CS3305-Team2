...
export const NavbarButton = ({
  ...
  const baseStyles =
    "px-4 py-2 rounded-md bg-white button bg-white text-brand-text-primary text-sm font-bold relative cursor-pointer hover:-translate-y-0.5 hover:bg-brand-hover hover:text-brand-text-hover transition duration-200 inline-block text-center";

  const variantStyles = {
    primary:
      "bg-brand-primary shadow-[0_0_24px_rgba(34,_42,_53,_0.06),_0_1px_1px_rgba(0,_0,_0,_0.05),_0_0_0_1px_rgba(34,_42,_53,_0.04),_0_0_4px_rgba(34,_42,_53,_0.08),_0_16px_68px_rgba(47,_48,_55,_0.05),_0_1px_0_rgba(255,_255,_255,_0.1)_inset]",
